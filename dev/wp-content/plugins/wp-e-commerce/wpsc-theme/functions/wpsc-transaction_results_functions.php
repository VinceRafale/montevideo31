...
function wpsc_transaction_theme() {
	...
	*/
	...
	$sessionid = $_SESSION['atos-session-id'];
	...
	if(!$dont_show_transaction_results ) {
		...
		printf( __( 'BLABLA Sorry your transaction was not accepted.<br /><a href="%1$s">Click here to go back to checkout page</a>.', 'wpsc' ), get_option( "shopping_cart_url" ) );
	}
