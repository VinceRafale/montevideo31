<?php
/*
Plugin Name: Bew - GN - Gestion des cours
Plugin URI: BEW Culture website
Description: Add custom post type les-cours
Author: Gabriel Nau
Author URI: mailto: gabriel.nau@gmail.com
Version: 0.1
*/

add_action( 'init', 'gn_post_type_eve_cours', 99 );

function gn_post_type_eve_cours(){
	...
	$labels = array(
    	...
    	'new_item' => 'Ajouter un cours',
    	'view_item' => 'Visualiser un cours',
    	'search_items' => 'Chercher un cours',
    	'not_found' => 'Aucun cours trouv&eacute;',
    	'not_found_in_trash' => 'Aucun cours trouv&eacute; dans la corbeille', 
    	'parent_item_colon' => ''
  	);
  	...
  	$args = array(
    	...
    	'show_ui' => true, 
    	'query_var' => false,
    	'rewrite' => array('slug' => 'les-cours','with_front' => true),
  	...
  	register_post_type('les-cours', $args);

}

register_activation_hook( __FILE__, 'gn_post_type_eve_cours_Activate' );

function gn_post_type_eve_cours_Activate(){
