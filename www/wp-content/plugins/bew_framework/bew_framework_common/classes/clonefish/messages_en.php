...
define('CF_STR_REQUIRED_CHECKBOX',      "Il est obligatoire de cocher la case '%s'");
...
define('CF_STR_REQUIRED_TEXT',      "Le champ '%s' est obligatoire");
...
define('CF_ERR_DIRECTORY_INACCESSIBLE',                   'CLONEFISH: "%s" input (file selector): the "%s" directory does not exist, or cannot be accessed (or the "directory" array element is not defined in the input configuration)');
