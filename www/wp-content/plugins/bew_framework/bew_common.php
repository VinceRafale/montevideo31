...
EOD;
    ...
    return '<div class="bew_redirect_js">'.__('Redirection dans').$redirect.__('secondes').'<br /><div class="bew_redirect_js_continue"><a href="'.$url.'" class="button">'.__('Continuer').' &raquo;</a><div class="clear"></div></div></div>';
