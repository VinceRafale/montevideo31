...
function  bew_event_meta(){
		...
		$dispo = get_post_meta($id, '_bew_event_places', true); 
        ...
        <?php elseif($available > 0) : ?>
          <span class="event_meta event_book" style="padding:0"><a href="<?php the_permalink(); ?>?" class="button"><?php _e('Book'); ?> &raquo;</a></span>
