...
function pce_pending($pce_newstatus, $pce_oldstatus, $pce_object) {
    global $wpdb, $pce_db_group, $pce_db_collab, $pce_siteurl, $pce_blogname, $pce_fromname, $pce_fromaddress, $pce_whoapproved, $pce_emails_to_send, $user_identity, $user_email, $_POST;
    ...
    elseif( $pce_emails_to_send['approved'] && 'pending' == $pce_oldstatus && 'publish' == $pce_newstatus )
    {
        ...
        if( $pce_whoapproved )
        {
            ...
            //sprintf( __( 'Your post has been approved by %s and is now published', 'peters_collaboration_emails' ), $pce_fromname );
        }
        else
        {
            $pce_body .= __( 'Your post has been approved', 'peters_collaboration_emails' );
...
?>
    <div class="wrap">
        ...
        <h4><?php _e('Add post-type-specific moderators', 'peters_collaboration_emails'); ?></h4>
            ...
            print __( 'Post type:' ) . ' <select name="post_types" id="post_types">';
            ...
            print '</select><br /><br />';
            print __( 'Taxonomy:' ) . ' <select name="taxonomy_types" id="taxonomy_types">';
            print '</select><br /><br />';
            
            print __( 'Term:' ) . ' <select name="taxonomy_terms" id="taxonomy_terms">';
            print '</select>';
