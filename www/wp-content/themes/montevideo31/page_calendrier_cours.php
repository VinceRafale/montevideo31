<?php
/*
Template Name: Page calendrier cours 
*/
...
<div id="container">
	<div id="content" role="main">
		...
		<?php 
		// display calendar
		echo do_shortcode( '[google-calendar-events id="1"]' ); 
		?>
		
		<div id="even_pagination_container">
			<!-- Title of the subpage -->
			<h1 class="entry-title">Liste des Cours :</h1>
			<?php 
			// display list
			echo do_shortcode( '[google-calendar-events id="11" type="list"]' );
			?>
