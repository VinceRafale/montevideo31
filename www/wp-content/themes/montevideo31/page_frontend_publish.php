	...
	<!-- Display title and custom text content -->
		...
		if( $saved ){
			...
			<form  method="post" action="#" enctype="multipart/form-data">
				...
				<!-- post Content -->
				<fieldset class="frontend_publish_form">
					<label for="frontpostcontent">Corps de l'article :</label>
					<textarea class="frontend_publish_form_input" tabindex="15" name="frontpostcontent" cols="80" rows="10"><?= $content ?></textarea>
				</fieldset>
