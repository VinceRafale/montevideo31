...
class mapMarker extends element {
  ...
  function getScripts() {
     ...
     return
       ...
       '<script src="http://maps.google.com/jsapi?key=' . $this->key . '" type="text/javascript"></script>' . "\n" .
       '<script src="' . $this->form->_normalizePath( $this->jspath ) . 'proxy/googlemap.js" type="text/javascript"></script>' . "\n" .
       '<script src="' . $this->form->_normalizePath( $this->jspath ) . 'addresschooser.js" type="text/javascript"></script>' . "\n"
     ;
