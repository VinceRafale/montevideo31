...
<?php
	...
	// RŽcupŽration de la variable cryptŽe DATA
	$message="message=$HTTP_POST_VARS[DATA]";

	// Initialisation du chemin du fichier pathfile (ˆ modifier)
	    //   ex :
	...
	//Initialisation du chemin de l'executable response (ˆ modifier)
	//ex :
	...
	// Initialisation du chemin du fichier de log (ˆ modifier)
    //   ex :
    //    -> Windows : $logfile="c:\\repertoire\\log\\logfile.txt";
    //    -> Unix    : $logfile="/home/repertoire/log/logfile.txt";
    //

	$logfile="/homez.395/synagogud/atos/logfile.txt";
  ...
  if (( $code == "" ) && ( $error == "" ) )
	...
	// OK, Sauvegarde des champs de la rŽponse
