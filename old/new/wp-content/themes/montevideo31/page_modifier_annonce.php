				...
				if( !is_user_logged_in() ) {
					...
					if( $annonceUserId == $current_user->ID ){
						...
						<fieldset class="frontend_publish_form">
							...
							<textarea id="" tabindex="15" name="content" cols="80" rows="10"><?= $annonceContent ?></textarea>
						</fieldset>
					...
					<?php 
						...
						echo "annonce user id " . $annonceUserId . " current user : " . $current_user->ID;
						var_dump($annonceUserId);
						?>
						<div class="frontend_publish_error">
